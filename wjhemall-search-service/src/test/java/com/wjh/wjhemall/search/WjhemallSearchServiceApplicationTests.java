package com.wjh.wjhemall.search;
...
@SpringBootTest
public class WjhemallSearchServiceApplicationTests {
...
//            List<PmsSearchSkuInfo> pmsSearchSkuInfos = new ArrayList<>();
        ...
        for (PmsSearchSkuInfo pmsSearchSkuInfo : pmsSearchSkuInfos) {
            Index put = new Index.Builder(pmsSearchSkuInfo).index("wjhemall").type("PmsSkuInfo").id(pmsSearchSkuInfo.getId()+"").build();
    ...
    public void get() throws IOException {
        ...
        Search search = new Search.Builder(dslStr).addIndex("wjhemall").addType("PmsSkuInfo").build();
